class ArticlesController < ApplicationController 
    ...
    before_action :require_user, except: [:show, :index] # requires user for certain actions(edit,new,destroy)
    ...
    def show
        # byebug                               # for @article set_article -> private method is used
    ...
    def edit            # for @article set_article -> private method is used
    ...
    def update 
        # byebug
        # @article = Article.find(params[:id])    # instead set_article -> private method is used
